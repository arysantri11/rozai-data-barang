...
$queryDataKeluar = mysqli_query($conn, "SELECT * FROM keluar JOIN stock ON stock.idbarang=keluar.idbarang");
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">BSI KCP KRAKATAU</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-bordered" width="100% cellspacing="0">
                                    ...
                                    <?php 
                                        $no = 1;
                                        while ($item = mysqli_fetch_assoc($queryDataKeluar)) { 
                                        ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
     ...
     <div class="modal fade" id="myModal">
      ...
      <select name="idbarang" class="form-control">
        <?php
            ...
            while($item = mysqli_fetch_array($ambilsemuadatanya)){
        ?>
      ...
      <br>
      <input type="datetime-local" name="tanggal" class="form-control" placeholder="Tanggal" require>
      <br>
